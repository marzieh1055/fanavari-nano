...
const userRoutsO = [ "updategenuineUserInfo","updatelegaluserInfo","uploadPic" , "tashilat" , "dashboarduser" , "addFacilities" , "updateFact" , "viewRequest" , "oploadDoc" , "WarrantyDocuments" , "WarrantyDocumentsUp" , "FacilitiesDocuments" , "legaluserInfo" , "genuineUserInfo"]
