...
const Input = ({ lable, type, src , changeHandler , value , name , onFocus } ) => {
        if (type === "text") {
            return (
                <div class="relative">
                    ...
                    <input onFocus={onFocus} onChange={changeHandler} value={value} name={name} id="form-1" className="border border-gray-300 focus-within:outline-none focus-within:border-black bg-white w-full py-4 pl-3.5 pr-c-20" type={type} />       
        ...
        if (type === "password") {
            ...
            return (
                ...
                <img className="absolute top-1/2 -translate-y-1/2 right-3 w-6 h-6" src={src} alt="" />
                <input onFocus={onFocus} onChange={changeHandler} value={value} name={name} id="form-2" className="border border-gray-300 focus-within:outline-none focus-within:border-black bg-white w-full py-4 px-c-20" type={type} />
